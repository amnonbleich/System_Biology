...
plotSequence(intrinsic_feedback, startState = start_state_in_feedback)
...
attractors_in_feedback=getAttractors(intrinsic_feedback, type="asynchronous", method="chosen", startStates = list(start_state_in_feedback),  returnTable=T)
attractors_in_feedback=getAttractors(intrinsic_feedback, type="synchronous", method="chosen", startStates = list(start_state_in_feedback),  returnTable=T)
